...
admin.site.site_header = "ARKDE"
admin.site.site_title = "ARKDE Admin Portal"
admin.site.index_title = "ARKDE Admin"

# swagger
api_info = openapi.Info(
    title="ARKDE API",
    default_version="v1",
    description="API documentation for ARKDE App",
)
